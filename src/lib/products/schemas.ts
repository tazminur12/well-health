...
export const productInputSchema = z
  .object({
    ...
    strengthUnit: z.string().trim().max(20).optional().or(z.literal("")),
    packSize: z.string().trim().max(80).optional().or(z.literal("")),
    quantityPerPack: z.number().int().min(1).max(100000).optional(),
    routeOfAdmin: z.string().trim().max(60).optional().or(z.literal("")),
    servingSize: z.string().trim().optional().or(z.literal("")),
